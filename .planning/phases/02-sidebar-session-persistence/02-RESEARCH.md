...
function magneticSnap(value: number, gridSize: number, threshold: number): number {
...
```
*Source: Dracula spec from [draculatheme.com/spec](https://draculatheme.com/spec), One Dark from [atom-one-dark-terminal](https://github.com/nathanbuchar/atom-one-dark-terminal)*
...
/>
```
*Source: [React Flow SnapGrid API](https://reactflow.dev/api-reference/types/snap-grid)*
...
```
*Source: [Tauri Window Customization](https://v2.tauri.app/learn/window-customization/)*
