...
1. **Canvas dot grid disappears at zoom-out**: When zooming out, the dot grid becomes nearly invisible. The dots don't scale to remain visible at lower zoom levels. They should feel infinite — always visible regardless of zoom level, like Excalidraw's grid that adjusts dot size/density based on zoom.
