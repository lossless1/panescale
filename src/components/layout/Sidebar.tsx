...
import { WorkspacesDropdown } from "../sidebar/WorkspacesDropdown";
...
export function Sidebar() {
  ...
  const workspacesAnchorRef = useRef<HTMLButtonElement>(null);
  ...
  return (
    ...
    >
      ...
      >
        {/* Workspaces dropdown — first so it sits closest to traffic lights */}
        <div style={{ position: "relative", marginRight: 6 }}>
          <button
            ref={workspacesAnchorRef}
